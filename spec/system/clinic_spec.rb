...
RSpec.describe 'clinic', type: :system do
  ...
  it '予約の編集で同じ時間で作成するとバリデーションがかかるできる事' do
    ...
    find(:xpath, '/html/body/div[1]/table[2]/tbody[2]/tr/td[4]/a').click
    click_button '変更する'
  ...
  it '予約の削除ができる' do
    find("#clinic_show").click
    find(:xpath, '/html/body/div[1]/table[2]/tbody[2]/tr/td[5]/a').click
  ...
  it 'お知らせの編集ができる' do
    find("#clinic_show").click
    find(:xpath, '/html/body/div[3]/table/tbody/tr[2]/td[2]/a').click
    click_on '更新する'
  ...
  it 'お知らせの削除ができる' do
    find("#clinic_show").click
    find(:xpath, '/html/body/div[3]/table/tbody/tr[2]/td[3]/a').click
    expect(page).to have_content 'お知らせを削除しました！'
  end

  it '全ての予約ができる' do
    find("#clinic_show").click
    find(:xpath, '/html/body/div[1]/a[1]').click
    expect(page).to have_content '2020年 01月03日 12:00'
  end
